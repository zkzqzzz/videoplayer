...
public class VideoPlayerStandard extends VideoPlayer {
    ...
    public void init(Context context) {
        ...
        cacheImageView = (ResizeImageView) findViewById(R.id.cache);
    ...
    public int getLayoutId() {
        return R.layout.vp_layout_standard;
    }
            ...
            switch (event.getAction()) {
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (!mChangePosition && !mChangeVolume) {
                        onEvent(BuriedPointStandard.ON_CLICK_BLANK);
                        onClickUiToggle();
                    }
                    break;
            }
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.thumb) {
            ...
            if (VideoPlayerManager.CURRENT_SCROLL_LISTENER.get() != null) {
                if (VideoPlayerManager.CURRENT_SCROLL_LISTENER.get().getUrl() != MediaManager.instance().mediaPlayer.getDataSource()) {
//                    if (!((VideoPlayer) VideoPlayerManager.CURRENT_SCROLL_LISTENER.get(0).get()).isShown()) {
                        releaseAllVideos();
                        return;
//                    }
                }
    ...
    private void obtainCache() {
        ...
        if (videoSize != null) {
            Bitmap bitmap = MediaManager.textureView.getBitmap(videoSize.x, videoSize.y);
            if (bitmap != null) {
    ...
    public void refreshCache() {
        if (pauseSwitchCoverBitmap != null) {
            VideoPlayerStandard jcVideoPlayer = ((VideoPlayerStandard) VideoPlayerManager.getFirst());
    ...
    public void onInfo(int what, int extra) {
        ...
        if (what == IMediaPlayer.MEDIA_INFO_VIDEO_ROTATION_CHANGED) {
            cacheImageView.setRotation(MediaManager.instance().videoRotation);
        }
    }
    ...
    public void onVideoSizeChanged() {
        ...
        cacheImageView.setVideoSize(MediaManager.instance().getVideoSize());
    }
    ...
    public void startPlayLogic() {
        prepareVideo();
        startDismissControlViewTimer();
        onEvent(BuriedPointStandard.ON_CLICK_START_THUMB);
    }
    ...
    public void showProgressDialog(float deltaX, String seekTime, int seekTimePosition, String totalTime, int totalTimeDuration) {
        ...
        if (mProgressDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.vp_progress_dialog, null);
            ...
            mProgressDialog = new Dialog(getContext(), R.style.vp_style_dialog_progress);
            ...
            localLayoutParams.x = getResources().getDimensionPixelOffset(R.dimen.vp_progress_dialog_margin_top) / 2;
        ...
        if (deltaX > 0) {
            mDialogIcon.setBackgroundResource(R.drawable.vp_forward_icon);
        } else {
            mDialogIcon.setBackgroundResource(R.drawable.vp_backward_icon);
        }
    ...
    public void showVolumeDialog(float deltaY, int volumePercent) {
        ...
        if (mVolumeDialog == null) {
            View localView = LayoutInflater.from(getContext()).inflate(R.layout.vp_volume_dialog, null);
            View content = localView.findViewById(R.id.content);
            content.setRotation(90);
            mDialogVolumeProgressBar = ((ProgressBar) localView.findViewById(R.id.volume_progressbar));
            mVolumeDialog = new Dialog(getContext(), R.style.vp_style_dialog_progress);
